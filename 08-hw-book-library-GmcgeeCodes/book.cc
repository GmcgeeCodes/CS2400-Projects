...
string Book::getTitle() const{ // Getter fot title
	return  title;
}
...
void Book::output(){  // Output helper function for class Book not needed anymore
	cout <<"The author is: "<< author << endl;
	cout<<"The title is: "<< title << endl;
	cout<<"The year is: "<< year << endl;
}
ostream& operator <<(ostream &outs, Book& bookOutput){
	outs <<"Title: "<< bookOutput.getTitle() <<", " << "Author: " << bookOutput.getAuthor() <<", "<<"Year: "<< bookOutput.getYear() << endl;
	return outs;
}